...
extern "C" {
    ...
    LLAMA_API struct llama_model * llama_model_load_from_buffer(const uint8_t * data, size_t size,
                                                                struct llama_model_params params);
    ...
    LLAMA_API struct llama_model * llama_model_load_from_split_futures(
                             const char ** paths,
                                 size_t    n_paths,
                               const char* context,
