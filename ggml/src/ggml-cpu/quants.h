...
void quantize_row_tq3_0_64(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
void quantize_row_tq4_0_64(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
