...
#define CREATE_FA(TYPE, NAMELC, FAPATH, SUFFIX) \
    ...
    CREATE_FA(GGML_TYPE_TQ4_0, tq4_0, FA_SCALAR, )
...
#define CREATE_MM2(PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT) \
        ...
        // TQ3_0/TQ4_0 f16 pipelines not registered here — coopmat2 variants not available
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        if (device->coopmat_acc_f16_support) {
            ...
            CREATE_MM2(GGML_TYPE_TQ3_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_TQ3_0], matmul_tq3_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM2(GGML_TYPE_TQ4_0, pipeline_dequant_mul_mat_mat[GGML_TYPE_TQ4_0], matmul_tq4_0_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
...
#undef CREATE_MM
    ...
    for (uint32_t w = 0; w < DMMV_WG_SIZE_COUNT; ++w) {
        ...
        for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_TQ3_0][i], "mul_mat_vec_tq3_0_f32_f32", arr_dmmv_tq3_0_f32_f32_len[reduc], arr_dmmv_tq3_0_f32_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {1*rm_stdq, 1, 1}, {128, 1*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_TQ4_0][i], "mul_mat_vec_tq4_0_f32_f32", arr_dmmv_tq4_0_f32_f32_len[reduc], arr_dmmv_tq4_0_f32_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {1*rm_stdq, 1, 1}, {128, 1*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_TQ3_0][i], "mul_mat_vec_tq3_0_f16_f32", arr_dmmv_tq3_0_f16_f32_len[reduc], arr_dmmv_tq3_0_f16_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {1*rm_stdq, 1, 1}, {128, 1*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_TQ4_0][i], "mul_mat_vec_tq4_0_f16_f32", arr_dmmv_tq4_0_f16_f32_len[reduc], arr_dmmv_tq4_0_f16_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {1*rm_stdq, 1, 1}, {128, 1*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_TQ3_0],  "dequant_tq3_0",   dequant_tq3_0_len,   dequant_tq3_0_data,   "main", 2, 5 * sizeof(uint32_t), {128, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_TQ4_0],  "dequant_tq4_0",   dequant_tq4_0_len,   dequant_tq4_0_data,   "main", 2, 5 * sizeof(uint32_t), {128, 1, 1}, {}, 1);
    ...
    if (device->float_controls_rte_fp16) {
        ...
        ggml_vk_create_pipeline(device, device->pipeline_cpy_f32_quant[GGML_TYPE_TQ4_0], "cpy_f32_tq4_0", cpy_f32_tq4_0_rte_len, cpy_f32_tq4_0_rte_data, "main", 2, sizeof(vk_op_unary_push_constants), {32, 1, 1}, {}, 1);
    } else {
        ...
        ggml_vk_create_pipeline(device, device->pipeline_cpy_f32_quant[GGML_TYPE_TQ4_0], "cpy_f32_tq4_0", cpy_f32_tq4_0_len, cpy_f32_tq4_0_data, "main", 2, sizeof(vk_op_unary_push_constants), {32, 1, 1}, {}, 1);
    }
...
#define SET_ROWS(itype, rte) \
        ...
        ggml_vk_create_pipeline(device, device->pipeline_set_rows ## itype [GGML_TYPE_TQ4_0], "set_rows_tq4_0" #itype, set_rows_tq4_0 ## itype ## rte ## _len, set_rows_tq4_0 ## itype ## rte ## _data, "main", 3, sizeof(vk_op_binary_push_constants), {1, 1, 1}, {1}, 1, true);
...
#undef SET_ROWS
    ...
    ggml_vk_create_pipeline(device, device->pipeline_cpy_quant_f32[GGML_TYPE_TQ4_0], "cpy_tq4_0_f32", cpy_tq4_0_f32_len, cpy_tq4_0_f32_data, "main", 2, sizeof(vk_op_unary_push_constants), {(uint32_t)ggml_blck_size(GGML_TYPE_TQ4_0), 1, 1}, {}, 1);
...
static void ggml_vk_mul_mat(ggml_backend_vk_context * ctx, vk_context& subctx, const struct ggml_cgraph * cgraph, int node_idx) {
    ...
    // when ne12 and ne13 are one.
               ...
               src0->type != GGML_TYPE_TQ3_0_64 && src0->type != GGML_TYPE_TQ4_0_64) {
