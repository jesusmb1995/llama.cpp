...
void process_shaders() {
    ...
    for (const auto& tname : type_names) {
        ...
        // TQ3_0/TQ4_0 require FHT (shared memory + barriers) which doesn't fit
        // the generic mul_mat_vec pattern. They use the dequant→fp16 fallback.
