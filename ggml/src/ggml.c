...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQ3_0_64] = {
        .type_name                = "tq3_0_64",
        .blck_size                = QK_TQ_64,
        .type_size                = sizeof(block_tq3_0_64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tq3_0_64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tq3_0_64_ref,
    },
    [GGML_TYPE_TQ4_0_64] = {
        .type_name                = "tq4_0_64",
        .blck_size                = QK_TQ_64,
        .type_size                = sizeof(block_tq4_0_64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tq4_0_64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tq4_0_64_ref,
    },
};
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_TQ3_0_64:   result = quantize_tq3_0_64   (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_TQ4_0_64:   result = quantize_tq4_0_64   (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
