...
struct llama_model * llama_model_load_from_buffer(const uint8_t * data, size_t size, struct llama_model_params params) {
    std::unique_ptr<std::basic_streambuf<uint8_t>> loader_input_ptr = std::make_unique<Uint8BufferStreamBuf>(data, size);
    load_input_variant::buffer_load_input loader_input{ loader_input_ptr };
